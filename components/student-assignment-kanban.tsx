          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-medium">
                {assignment.startDate ? formatDate(assignment.startDate.toString()) : 'TBD'}
              </span>
            </div>
            <div className="flex items-center justify-between text-xs">
              <span className="text-gray-500">Due</span>
              <span className="font-medium">
                {assignment.dueDate ? formatDate(assignment.dueDate.toString()) : 'TBD'}
              </span>
            </div>
            {assignment.evaluationStartDate && assignment.evaluationDueDate && (
              <>
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-medium">
                    {assignment.evaluationStartDate ? formatDate(assignment.evaluationStartDate.toString()) : 'TBD'}
                  </span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-gray-500">Eval Due</span>
                  <span className="font-medium">
                    {assignment.evaluationDueDate ? formatDate(assignment.evaluationDueDate.toString()) : 'TBD'}
                  </span>
                </div>
              </>
            )}
